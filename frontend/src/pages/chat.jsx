...
//         {
//           role: "bot",
//           text: "Hi 👋 I can help you . Ask me about anything !",
//         },
//       ],
//     },
//   ]);
...
//                   className="input"
//                   onChange={(e) =>
//                     setNeo4j({ ...neo4j, uri: e.target.value })
//                   }
//                 />
//                 <input
...
//                   className="input"
//                   onChange={(e) =>
//                     setNeo4j({ ...neo4j, user: e.target.value })
//                   }
//                 />
//                 <input
//                   type="password"
...
//                   className="input"
//                   onChange={(e) =>
//                     setNeo4j({ ...neo4j, password: e.target.value })
//                   }
//                 />
...
//             {/* HEADER */}
//             <div className="px-6 py-5 border-b bg-gradient-to-r from-indigo-50 via-violet-50 to-fuchsia-50">
//               <h3 className="text-lg font-extrabold text-slate-900">
//                 {activeChat?.title || "Chat"}
//               </h3>
